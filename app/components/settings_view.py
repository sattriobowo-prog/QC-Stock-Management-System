        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.div(
                    ...
                    rx.el.div(
                        "Clears all transactional data (requests, issues, receivings, adjustments, transfers, audit log) while preserving items, lots, vendors, and settings. This action is irreversible and is restricted to the Admin role only.",
                    ...
                    rx.el.div(
                        rx.el.input(
                            ...
                            on_change=GovernanceState.set_reset_confirm.debounce(
                                300
                            ),
                    ...
                    rx.cond(
                        ...
                        rx.el.div(
                            rx.icon(
                                "lock", class_name="h-3.5 w-3.5 text-red-500"
                            ),
                            rx.el.span(
