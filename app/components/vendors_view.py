    ...
    return rx.fragment(
        rx.el.div(
            rx.el.div(
                ...
                rx.cond(
                    GovernanceState.can_manage_vendors,
                    rx.el.span(
                        "Sensitive contact fields visible (manage_vendors permission)",
                        class_name="text-[10px] font-medium px-2 py-1 rounded bg-blue-50 text-blue-700 border border-blue-200",
                    ),
                    rx.el.span(
                        "Sensitive contact fields masked (server-side restriction)",
                        class_name="text-[10px] font-medium px-2 py-1 rounded bg-gray-50 text-gray-600 border border-gray-200",
                    ),
                ),
        ...
        rx.el.div(
            ...
            rx.el.div(
                rx.el.table(
                    ...
                    rx.el.tbody(
                        rx.foreach(
                            GovernanceState.visible_vendors,
                            lambda v: rx.el.tr(
                                rx.el.td(
                                    v["code"],
